...
const { addDishRestaurant, getDishFilteredByRestaurant } = require("../controlers/dish.controlers");
const { getRestaurants, addRestaurant } = require("../controlers/restaurant.controlers");
